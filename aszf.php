...
<body>
     ...
     <main class="main">
      ...
      <section class="section">
        <div class="card">
            <div class="card-body">
              <center><h1>ÁSZF</h1></center>
              <hr class="hr1">
              <p>
                <strong>Az adatkezelés jogalapja:</strong>
                Az államháztartásról szóló 2011. évi CXCV. törvény 106/A.§-a, valamint az érintett hozzájárulása az információs
                önredelkezési jogról és az információszabadságról szóló 2011. évi CXII. törvény 5.§(1) a) pont alapjá <br>
                Jelen Tájékoztató azt a célt szolgálja, hogy az elektronikus fizetési megtekintéséhez 
                szükséges - az elektronikus ügyintézés és a bizalmi szolgáltatások általános szabályairól szóló 2015. évi CCXXII. 
                törvény által szabályozott, Központi Azonositási Ügynök (KAÜ) szolgáltató részére megadott azonosítások megadásával - 
                személyes adatai kincstár általi kezelésének jogszabályai hátterét és jogalapját megismerje.
              </p>
            </div>
          </div>
    </section>
