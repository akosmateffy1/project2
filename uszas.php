     ...
     <main>
      <section class="about" id="about">
        ...
        <div class="row">
          ...
          <div class="image">
              <img src="img/STA-Image-laila-and-family.jpg">
          </div>
      
          <div class="content">
            <h3>Leírás</h3>
            <p>Uszál velünk a nyáron! Visegrádon! A nyári táborban. kiscsoportos foglalkozások, kiváló hangulat és rengeteg jó program várja minden táborozónkat idén nyáron is! Több Sportra is lehetőség van!</p>

            <p>A uszótáborban naponta 7x8 óra (összesen 60 perc), képzett és kedves, angolul is beszélő uszóedzőink által tartott aktív foci oktatás várja 6-16 éves táborozóinkat, kor és tudás szerint bontott csoportokban (4-7 gyermek/csoport). Nagyobbaknak további felügyelt Uszó medencét is biztosítunk.</p>
        </div>
      ...
      <section class="about" id="about">
        <div class="row">
          <div class="content">
            <h3>Uszó Medencéink</h3>
            <p>Itt Látható a Uszó medencéink. Hétfőtől-Péntekig rendelkezésünkre áll. Minden nap edzési lehetőség 8:00-18:00-ig.</p> 
         </div>
          <div class="image">
      ...
      <section class="about" id="about">
        ...
        <div class="row">
          ...
          <div class="image">
              <img src="img/istockphoto-1167733673-170667a.jpg" alt="">
          </div>
