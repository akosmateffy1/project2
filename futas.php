     ...
     <main>
      <section class="about" id="about">
        ...
        <div class="row">
          ...
          <div class="image">
              <img src="img/atletika.1..jpg" alt="">
          </div>
      
          <div class="content">
            <h3>Leírás</h3>
            <p>Atletizálj velünk a nyáron! Visegrádon! A nyári táborban. kiscsoportos foglalkozások, kiváló hangulat és rengeteg jó program várja minden táborozónkat idén nyáron is! Több Sportra is lehetőség van!</p>

            <p>A Atlétika táborban naponta 7x8 óra (összesen 60 perc), képzett és kedves, angolul is beszélő Atlétika edzőink által tartott aktív Atlétikai oktatás várja 6-16 éves táborozóinkat, kor és tudás szerint bontott csoportokban (4-7 gyermek/csoport). Nagyobbaknak további felügyelt foci pálya-használatot is biztosítunk.</p>
        </div>
      ...
      <section class="about" id="about">
        <div class="row">
          <div class="content">
            <h3>Atlétikai Pályánk</h3>
            <p>Itt Látható a Atlétikai pályánk. Hétfőtől-Péntekig rendelkezésünkre áll. Minden nap edzési lehetőség 8:00-18:00-ig.</p>
         </div>
          <div class="image">
              <img src="img/fupalya.jpg" alt="">
          </div>
       </div>
      </section>
      ...
      <section class="about" id="about">
        ...
        <div class="row">
          ...
          <div class="image">
              <img src="img/atlétika1.1..webp" alt="">
          </div>
