     ...
     <main>
      <section class="about" id="about">
        ...
        <div class="row">
          ...
          <div class="image">
              <img src="img/kezi.jpg" alt="">
          </div>
      
          <div class="content">
            <h3>Leírás</h3>
            <p>Kosarazz velünk a nyáron! Visegrádon! A nyári táborban. kiscsoportos foglalkozások, kiváló hangulat és rengeteg jó program várja minden táborozónkat idén nyáron is! Több Sportra is lehetőség van!</p>

            <p>A Kosár táborban naponta 7x8 óra (összesen 60 perc), képzett és kedves, angolul is beszélő kosár edzőink által tartott aktív kosár oktatás várja 6-16 éves táborozóinkat, kor és tudás szerint bontott csoportokban (4-7 gyermek/csoport). Nagyobbaknak további felügyelt kosár páylát biztosítunk.</p>
        </div>
      ...
      <section class="about" id="about">
        <div class="row">
          <div class="content">
            <h3>Kosárlabda Pályánk</h3>
            <p>Itt Látható a Kosárlabda pályánk. Hétfőtől-Péntekig rendelkezésünkre áll. Minden nap edzési lehetőség 8:00-18:00-ig.</p> 
         </div>
          <div class="image">
              <img src="img/kosi.jpg" alt="">
          </div>
       </div>
      </section>
