   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="password" name="update_pass" placeholder="írja be a régi jelszavát" class="box">
            <span>Új jelszó :</span>
            <input type="password" name="new_pass" placeholder="írja be az új jelszavát" class="box">
            <span> Jelszó újra :</span>
            <input type="password" name="confirm_pass" placeholder="ismételje meg az új jelszavát" class="box">
         </div>
      </div>
